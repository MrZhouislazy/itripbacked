...
<mapper namespace="cn.${package}.mapper.${table.className}Mapper">
    ...
    <select id="get${table.className}ById" resultType="cn.${package}.model.${table.className}" >
        select
    ...
    <select id="get${table.className}ListByMap" resultType="cn.${package}.model.${table.className}" parameterType="java.util.Map">
        select
        <#list table.cloumns as cloumn>
            <#if cloumn_has_next>
                ${cloumn.cloumnName} as ${cloumn.fieldName},
    ...
    <insert id="insert${table.className}" parameterType="cn.${package}.model.${table.className}">
    ...
    <update id="update${table.className}" parameterType="cn.${package}.model.${table.className}">
